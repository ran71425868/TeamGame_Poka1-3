...
void ACookingStation::OnCookingFinished1()
{
	...
	if (CompleteSound)
	{
		UGameplayStatics::PlaySoundAtLocation(this, CompleteSound, ItemSocket1->GetComponentLocation());
	// --- 【追加】完成したらソケット1の音を止める ---
...
void ACookingStation::OnCookingFinished2()
{
	...
	if (CompleteSound)
	{
		UGameplayStatics::PlaySoundAtLocation(this, CompleteSound, ItemSocket2->GetComponentLocation());
	}
	// --- 【追加】完成したらソケット2の音を止める ---
